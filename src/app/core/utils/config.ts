...
export const keyPathDynamicReference: string = "charge.reference"
export const keyPathReference: string = "reference"
export const keyPathCurp: string = "curp"

export const keyUserID: string = "rc_uid"
export const keyDBVersion: string = "rc_vn"
...
export const lastPayment = "lastPayment"
